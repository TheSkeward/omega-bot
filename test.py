...
def test_scott_post_helper():
    ...
    for term in queries:
        try:
            ...
            print("Expected a random Scott article from scott_links.txt but got a File Not Found error")
            failure = True
        except KeyError:
            print("FAILURE: test_scott_post_helper()")
            print(
                f"Expected search result for 'https://www.googleapis.com/customsearch/v1?key={main.GOOGLE_API_KEY}&cx"
